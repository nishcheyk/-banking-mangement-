    ...
    <div>
      <div className="container">
        <div className="card-group">
          <div className="card" style={{ height: "270px" }}> {/* Increased height */}
        ...
        <p style={{ color: allPDFsOpened ? "#28a745" : "red", fontWeight: "bold", textAlign: "center" }}>
          {allPDFsOpened ? "All PDFs are opened. You can now Register." : "Please open all PDFs to enable the Register button."}
        </p>
        <div className="text-center"> {/* Center align the Register button */}
          <button
