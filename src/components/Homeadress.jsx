...
function MainForm() {
    ...
    return (
        <div className="address-container">
            ...
            <p className="address-paragraph">Please provide your current Indian residence address</p>

            {savedAddress && (
                <div id="savedAddress" className="address-saved-address">
                    <p className="address-paragraph">{savedAddress}</p>
                    <a className="address-manual-entry-link" onClick={handleRemoveAddress}>Remove address</a>
                    <a className="address-manual-entry-link" onClick={handleEditAddress}>Change address</a>
                </div>
            )}

            {!savedAddress && (
                <div className="address-form-group" id="searchAddressGroup">
                    <label htmlFor="address" className="address-label">SEARCH FOR YOUR ADDRESS</label>
                    <input
                        type="text"
                    ...
                    />
                    <p className="address-hint">Please enter an address or enter manually using the link below</p>
                    <a className="address-manual-entry-link" onClick={() => setShowAddressForm(true)}>Prefer to enter address manually</a>
                    <p id="addressError" className="address-error-message">{errors.addressError}</p>
                    {data && (
            ...
            <div className="address-form-group">
                <p className="address-paragraph">HOW LONG HAVE YOU LIVED AT THIS ADDRESS?</p>
                <p className="address-paragraph">If less than 6 months, we&apos ll also need details of your previous address.</p>
                ...
                <p id="durationError" className="address-error-message">{errors.durationError}</p>
            </div>

            <p className="address-warning">Please check your details above. You won &apos t be able to change them once you click continue.</p>

            <button className="address-continue-button" onClick={handleValidateAndContinue}>Continue</button>
            ...
            {showAddressForm && (
                <>
                    ...
                    <div className="address-address-form">
                        ...
                        <div className="address-form-group">
                            <label htmlFor="houseName" className="address-label">House Name</label>
                            <input
                                type="text"
                                id="houseName"
                                value={houseName}
                                ...
                                className="address-input"
                            />
                            <p id="houseNameError" className="address-error-message">{errors.houseNameError}</p>
                        </div>
                        <div className="address-form-group">
                            <label htmlFor="houseNumber" className="address-label">House Number</label>
                            <input
                                type="text"
                                id="houseNumber"
                                value={houseNumber}
                                ...
                                className="address-input"
                            />
                            <p id="houseNumberError" className="address-error-message">{errors.houseNumberError}</p>
                        </div>
                        <div className="address-form-group">
                            ...
                            <input
                                ...
                                className="address-input"
                            />
                            <p id="streetError" className="address-error-message">{errors.streetError}</p>
                        </div>
                        <div className="address-form-group">
                            <label htmlFor="townCity" className="address-label">Town/City</label>
                            <input
                                type="text"
                                id="townCity"
                                value={townCity}
                                ...
                                className="address-input"
                            />
                            <p id="townCityError" className="address-error-message">{errors.townCityError}</p>
                        </div>
                        <div className="address-form-group">
                            ...
                            <input
                                ...
                                className="address-input"
                            />
                            <p id="postcodeError" className="address-error-message">{errors.postcodeError}</p>
                        </div>
                        <div className="address-button-group">
                            <button className="address-close-button" onClick={() => setShowAddressForm(false)}>Close</button>
                            <button className="address-submit-button" onClick={handleSaveAddress}>Save Address</button>
                        </div>
                    </div>
                </>
            )}
